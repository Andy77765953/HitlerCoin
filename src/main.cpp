...
int64 nChainStartTime = 1458890509;
...
const string strMessageMagic = "HitlerCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if (nPoWHeight < 500)
       nSubsidy = 236000 * COIN; //Premin: 124862016
	 else if(nPoWHeight < 352857)
       nSubsidy = 8 * COIN;        //POW:5.9M
     else
       nSubsidy = 0 * COIN;
...
static const int YEARLY_POS_BLOCK_COUNT = 1440 * 30;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in HitlerCoin
    bool fStrictPayToScriptHash = true; // Always active in HitlerCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HitlerCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0x1f97e049237cedb751ba49b19b2a084984567f2400d4060f69ce50f18835ab03"));
